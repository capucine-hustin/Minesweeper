...
from tkinter import *
import random, winsound, sys, pygame
import webbrowser
...
def affiche_compteurs():
    ...
    # DÃ©compte des case à  traiter pour la fonction gagnÃ©
...
def perdu():
    ...
    winsound.PlaySound('C:/Users/jorda/OneDrive/Bureau/Coding Weeks/2048_game_codkings/explosion.wav', winsound.SND_FILENAME)
...
def gagne():
    ...
    winsound.PlaySound('C:/Users/jorda/OneDrive/Bureau/Coding Weeks/2048_game_codkings/gagne.wav', winsound.SND_FILENAME)
...
im_mine = PhotoImage(file = "C:/Users/jorda/OneDrive/Bureau/Coding Weeks/2048_game_codkings/minej.gif")
im_erreur = PhotoImage(file = "C:/Users/jorda/OneDrive/Bureau/Coding Weeks/2048_game_codkings/croixj.gif")
im_flag = PhotoImage(file = "C:/Users/jorda/OneDrive/Bureau/Coding Weeks/2048_game_codkings/drapeauj.gif")
...
my_button = Button(f4, text ="Play Song", font="Ebrima", bg='#20bebe', fg="white", height=2, width=10, command=play)
...
def openj():
    webbrowser.open_new("https://gitlab-ovh-01.cloud.centralesupelec.fr/jordan.boutoux/minesweeper_cs")
